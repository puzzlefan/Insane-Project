...
private:
	...
	std::string Zeile2[5] = { "R�der Paar", "Einzelnes Rad", "Einzelner C motor","Ultraschallsensor Check","Rotatationssensor Check" };
	std::string Zeile3[5] = { "R�der Paar", "Einzelnes Rad", "Einzelner C motor","Ultraschallsensor Check","Rotatationssensor Check" };
	...
	std::string Zeile5[14] = { "R�derpaar Vorne","R�derpaar Hinten","Einzelrad Vorne Links","Einzelrad Vorne Rechts","Einzelrad Hinten Links","Einzelrad Hinten Rechts","Einzel C Motor Vorne Links","Einzel C Motor Vorne Rechts","Einzel C Motor Hinten Links","Einzel C Motor Hinten Rechts","Ultraschall vorne","Ultraschall hinten","Rotation Cs","Rotation Rad" };
